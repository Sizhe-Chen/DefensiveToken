...
+ Install environment dependencies via [uv](https://docs.astral.sh/uv/getting-started/installation/): add our optimized DefensiveTokens to public model's vocabulary
